...
import { Lock, Unlock, Copy, RefreshCw, KeyRound, ArrowRightLeft, Check, X, Info, Loader2, Database, Shield } from 'lucide-react';
...
export const Obfuscator: React.FC<ObfuscatorProps> = ({ isOpen, onClose }) => {
  ...
  /**
   * syncDevelopmentVault: Accede al archivo Sheets, recupera las Claves 
   * de Desarrollo y permite su posterior desofuscación.
   */
        ...
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              title="Sincronizar Bóveda de Desarrollo"
            >
              <Database size={20} />
            </button>
            <button 
